...
function Video() {
  ...
  useEffect(() => {
    ...
    // https://www.youtube-nocookie.com/embed/4Su50PRr-xk
    // new YouTube(scene, camera, 'https://www.youtube.com/embed/Y1B4I20SvUA?rel=0')
    setTimeout(() => {
      // new YouTube(scene, camera, '4Su50PRr-xk', [0,0,0], [0,0,0], 1)
    }, 1000);
    // new YouTube(scene, camera, 'https://www.youtube.com/embed/bpOSxM0rNPM')
    // new YouTube(scene, camera, 'https://www.youtube.com/embed/4Su50PRr-xk')
  }, [])
}
