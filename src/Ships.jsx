    ...
    <>
      ...
      <group dispose={null} position={[0,-2,0]} scale={.07} rotation={[0, -Math.PI/2, 0]}>
        <group>
          ...
          <mesh ref={cloudBot} geometry={nodes.Circle002_Cloud_0.geometry} material={materials.Cloud} position={[-1.33, 46.25, 0.69]} rotation={[-Math.PI / 2, 0, 0]} scale={138.18} />
...
function SunkenShip({nodes, materials}) {
  return (
    <>
      ...
      <Cloud position={[0,1,30]} args={[3, 2]} />
